// Get rid of your data.ts file, as we will now use our database. Clean up so that everything compiles successfully.
// Now we can import our new Page model in the module that contains our controller:
